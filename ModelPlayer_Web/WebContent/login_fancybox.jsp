...
<html >
  <head>
	  ...
	  <link rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/css/login_fancybox.css">
  ...
  <body>
  	...
  	<%= errorList!=null?errorList:"" %>
  		<form action="<%= request.getContextPath() %>/login.do" class="box" method="post" autocomplete="off">
  			<h1>會 員 登 入</h1>
  			...
  			<span>
	  			<label ><img id="captchaImage" alt="" src="/mpr/images/captcha.jpg">
